	...
	<div class="modal-dialog modal-md">
      ...
      <div class="modal-body">
          ...
          <div class="panel-body">
        		<form class="form-horizontal" id="instructor-edit" method="put" enctype="multipart/form-data" files=true>
							@method('PUT')
              @csrf
              <fieldset class="content-group">
        				<legend class="text-bold">Edit Instructor</legend>
...
$(document).ready(function(){
    /* START OF SAVE DATA */
		$('#instructor-edit').on('submit', function (e) {
      e.preventDefault();
        $.ajax({
						'type': 'post',
						'url' : "{{ url('admin/instructor') }}"+"/"+$('input[name=id_edit]').val(),

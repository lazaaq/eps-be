      ...
      <div class="modal-body">
          ...
          <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                <div class="form-group">
                  <label class="control-label col-lg-3">Is Viewed Mobile<span class="text-danger">*</span></label>
                  <div class="col-lg-9">
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <label class="radio-inline col-md-3">
                      <input checked type="radio" id="viewCreateWeb" name="isViewWeb" value="1" class="styled">
                      View
                    </label>
                    <label class="radio-inline col-md-3">
                      <input type="radio" id="notViewCreateWeb" name="isViewWeb" value="0" class="styled">
                      Not View
                  </div>
                </div>
                <div class="form-group">

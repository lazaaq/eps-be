...
<head>
    ...
    <link rel="icon" href="{{asset('landing-page/img/favicon.png')}}" type="image/png">
	...
	<!-- <script type="text/javascript" src="{{asset('js/plugins/datetime/bootstrap-datetimepicker.min.js')}}"></script> -->
	<!-- <script type="text/javascript" src="{{asset('js/plugins/datetime/moment.min.js')}}"></script> -->

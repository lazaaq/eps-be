      ...
      <form id="form-edit-question" class="form-validate-jquery" action="{{route('question.update', $data->id)}}" method="post" enctype="multipart/form-data" files=true>
        ...
        <fieldset class="content-group">
          ...
          <div class="form-group">
            ...
            <input type="file" name="audio" class="file-input" data-show-caption="true" data-show-upload="false" accept=".mp3">
            @if ($errors->has('audio'))
              <label style="padding-top:7px;color:#F44336;">
                  <strong><i class="fa fa-times-circle"></i> {{$errors->first('audio')}}</strong>
              </label>
            @endif
          </div>
          <div class="form-group">
